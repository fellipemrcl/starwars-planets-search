const mockGrav = '1 standard';
const firstMovie = 'https://swapi.dev/api/films/1/';
const secondMovie = 'https://swapi.dev/api/films/2/';
const thirdMovie = 'https://swapi.dev/api/films/3/';
const fourthMovie = 'https://swapi.dev/api/films/4/';
const fifthMovie = 'https://swapi.dev/api/films/5/';
const sixthMovie = 'https://swapi.dev/api/films/6/';
